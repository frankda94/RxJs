...
(() => {
    ...
    const PERSONAJE_1 = '/people/1/';
    const SPECIE_1 = '/species/1/';
    // ==================================================================
    ...
    // getRequest(SW_API + PERSONAJE_1).pipe(
    //     switchMap(() => getRequest(SW_API + SPECIE_1).pipe(
    //     )),
    ...
    // Realizar el llamado al URL para obtener a Luke Skywalker
    getRequest(SW_API + PERSONAJE_1).pipe(
        switchMap(resp => zip(of(resp), getRequest(SW_API + SPECIE_1))),
